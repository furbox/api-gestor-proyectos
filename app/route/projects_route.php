...
$app->group('/projects/', function () {
   ...
   *
   * responde
   * La informacion de la del proyecto
   */
    $this->get('project/{id}', function ($req, $res, $args) {
        return $res->withHeader('Content-type', 'application/json')
                        ->write(json_encode($this->model->projects->getProject($args['id'])));
    });

    $this->get('list', function ($req, $res, $args) {
        return $res->withHeader('Content-type', 'application/json')
                        ->write(json_encode($this->model->projects->getAllProjects()));
    });
